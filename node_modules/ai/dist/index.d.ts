 ...
 */
type BatchRequest<ModelIds extends Experimental_BatchV4ModelIds = Experimental_BatchV4ModelIds, TOOLS extends ToolSet = ToolSet> = TextBatchRequest<ModelIds['text'], TOOLS>;
 ...
 */
type BatchItemResult<TOOLS extends ToolSet = ToolSet> = TextBatchItemResult<TOOLS>;
